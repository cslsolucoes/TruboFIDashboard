object frmCobrancaDashboard: TfrmCobrancaDashboard
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'frmCobrancaDashboard'
  ClientHeight = 930
  ClientWidth = 1429
  Color = 15005659
  ...
  object pPrincipal: TRzPanel
    ...
    object pnlGrafico: TRzPanel
      ...
      ShowHint = False
      TabOrder = 0
      object grfBarras: TDBChart
        Left = 431
        Top = 0
        Width = 998
        Height = 283
        Cursor = crHandPoint
        LeftWall.Color = 6402120
        Title.Color = clGreen
        ...
        Title.Text.Strings = (
          'Cobran'#231'as pendentes utilmos 12 meses')
        OnClickSeries = grfBarrasClickSeries
        Hover.Visible = False
      ...
      object grfCirculo: TDBChart
        ...
        Title.Font.Quality = fqBest
        Title.Text.Strings = (
          'Cobran'#231'as   Pendentes vs Concluidas')
    ...
    object pnlSetor: TRzPanel
      ...
      object lbSetor: TLabel
        ...
        Align = alTop
        Alignment = taCenter
        Caption = 'Lista de ordem de servi'#231'os por SETOR'
        Color = 15005659
        Font.Charset = DEFAULT_CHARSET
        Font.Color = 6402120
        Font.Height = -27
